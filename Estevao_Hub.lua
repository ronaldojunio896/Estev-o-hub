...
local Window = Libary:MakeWindow({
    Title = "た Estevão Hub",
    SubTitle = "English - Brookhaven RP 🏡",
    LoadText = "Estevão Developers",
    Flags = "EstevaoHub_Brookhaven"
})

Window:AddMinimizeButton({
    Button = { Image = "rbxassetid://101107248492443", BackgroundTransparency = 0 },
...
InfoTab:AddParagraph({ "Programmer:", "Estevão" })
InfoTab:AddParagraph({ "Team:", "Estevão Developers" })

InfoTab:AddSection({ "Discord" })
InfoTab:AddDiscordInvite({
    Name = "⽦ Estevão Studios",
    Description = "Stay up to date with all the news from our Hub",
    Logo = "rbxassetid://101107248492443",
    Invite = "dsc.gg/estevaostudios",
})
...
InfoTab:AddParagraph({ "You are Using:", "も Estevão Hub" })
InfoTab:AddParagraph({ "You are Using Version:", "1.0.0 - Beta" })
...
InfoTab:AddParagraph({ "We are using Nytherune, Chaos, Coquette as the base for our scripter" })--]]
...
--[[
local ADT = Window:MakeTab({ "Administrator", "code" })

ADT:AddSection({ "Administrator" })

ADT:AddSection({ "Administrator Limited" })
...
--]]
local GamePTab = Window:MakeTab({ "Spoofed Gamepass", "gamepad" })

GamePTab:AddSection({ "Spoofed Gamepass" })
...
GamePTab:AddTextBox({
    ...
    Callback = function(Value)
        ...
        if chatService.ChatVersion == Enum.ChatVersion.TextChatService then
            local msg = ". \r[Premium] " .. player.DisplayName .. ": " .. Value
...
Troll:AddSection({Name = "Shutdown Method"})
...
Troll:AddButton({
    Name = "[Recommend] Bring All Couch",
    Callback = function()
        local args = {
    [1] = "ClearAllTools"
}
...
SpamTab:AddSection({Name = "Spamming"})

SpamTab:AddSection({Name = "Jet"})

SpamTab:AddParagraph({"Warn", "This is irreversible, use with caution"})
...
SpamTab:AddButton({
    Name = "[BETA] Start Spamming the Player",
    Callback = function()
        startLoop2()
    end
})
...
SpamTab:AddButton({
    Name = "[BETA] Stop Spamming the Player",
    Callback = function()
        stopLoop2()
    end
})

SpamTab:AddSection({"Jet Local"})
...
SpamTab:AddParagraph({"Note", "Will start spamming jet at your player/character local"})

end

local Tab = Window:MakeTab({"Avatar Copy", "rbxassetid://10734952036"})

Tab:AddSection({ Name = "Avatar Copy" })

Tab:AddSection({ Name = "Copy" })
local Players = game:GetService("Players")
local ReplicatedStorage = game:GetService("ReplicatedStorage")
...
local Tab3 = Window:MakeTab({"Avatar Wearing", "rbxassetid://10734952036"})
local Section = Tab3:AddSection({"Avatar Wearing"})
...
local AvatarDropdown = Tab3:AddDropdown({
    Name = "Accessories 3D",
    Description = "Select one to equip",
    Default = nil,
...
Tab3:AddButton({
    Name = "Equip 3D",
    Description = "Equip the selected accessory",
    Callback = function()
...
local Tab3 = Window:MakeTab({"Avatar Editor", "rbxassetid://10734952036"})
local Section = Tab3:AddSection({"Avatar Editor"})

Tab3:AddSection({ "Invisible" })
Tab3:AddButton({
    Name = "Avatar Invisible",
    Description = "Everyone on the server can see it (it's not visual) ",
Callback = function()
...
LocalPlayerTab:AddButton({
    Name = "Spam Chat - Hacked by Estevão Hub",
    Callback = function()
        if game:GetService("TextChatService").ChatVersion == Enum.ChatVersion.TextChatService then 
            game:GetService("TextChatService").TextChannels.RBXGeneral:SendAsync("hi\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\rSystem: Hacked by Estevão Hub")
        else 
    end
end
})
...
ToolsTab:AddSection({ "Tools" })

ToolsTab:AddSection({ "Colorful" })
ToolsTab:AddButton({
    Name = "[OP] Coloring Floor Map",
    Callback = function()
...
if toolCount >= dupeamot then
    ...
    for m = 1, dupeamot do
        ...
        game:GetService("StarterGui"):SetCore("SendNotification", {
            Title = "Tool",
            Text = "Tools Duplicates: " .. m .. " / " .. dupeamot,
            Duration = 1
        })
        repeat
            if game:GetService("Workspace"):FindFirstChild("Camera") then
...
ToolsTab:AddDropdown({
    ...
    Description = "Choose a color combination to apply",
    Options = (function()
...
game:GetService("StarterGui"):SetCore("SendNotification",{Title="Warn!",Text="Please do not equip any tools or unequip tools or click tools on inventory. It will break the script.", Button1 = "I understand" ,Duration=5})
...
Section = ToolsTab:AddSection({
    Name = "Super Aura Grip"
})

ToolsTab:AddButton({
    Name = "Super Aura Smoke",
    Description = "The aura will appear if you hold the screen, then the smoke will appear",
    Callback = function()
local Players = game:GetService("Players")
local RunService = game:GetService("RunService")
local LocalPlayer = Players.LocalPlayer
...
local nametools = "Crystal Nz Lel"
